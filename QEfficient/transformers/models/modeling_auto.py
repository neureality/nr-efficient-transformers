...
class QEFFVisionTextModel(QEFFTransformersBase):
      pass

class QEFFAutoTextImageToText:
    def __init__(self,model):
        super().__init__(model)
        self.encoder_decoder=QeffVisionTextModel()
        self.decoder=QEFFAutoModelForCausalLM()

    def export(self,):
        self.encoder_decoder.export()
        self.decoder.export()

    def compile(self,*args,**kwargs):
        self.encoder_decoder.compile(**kwargs)
